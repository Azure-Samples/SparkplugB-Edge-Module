...
SparkPlug B and MQTT are used in the Industrial World; in specific sectors such as Oil & Gas, Energy, and manufacturing. In addition, devices such as PLCs, SCADAS, and Gateways can transmit telemetry through MQTT using the SparkPlug B format to obtain different advantages.
